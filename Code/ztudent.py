...
class Student_Details:
    def __init__(self, root):
        ...
        # first image1
        img1 = Image.open(
            r"C:\Users\kumar\Desktop\college_images\face-recognition.png")  # for calling the images fromfolder to window
        ...
        # second image
        img2 = Image.open(
            r"C:\Users\kumar\Desktop\college_images\smart-attendance.jpg")  # for calling the images fromfolder to window
        ...
        # for title in bg_img
        title_lbl = Label(bg_lbl, text=" Student Management System", font=("times new roman", 35, "bold"), bg="white",
                          fg="darkgreen")
        ...
        label_frameleft = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE, text="student Details",
                                     font=("tomes new roman", 12, "bold"))  # relief is used for border size
        label_frameleft.place(x=10, y=5, width=720, height=620)

        # left frame image
        left_img = Image.open(
            r"C:\Users\kumar\Desktop\college_images\thirds.jpg ")  # for calling the images fromfolder to window
        ...
        f1_lbl.place(x=5, y=0, width=708,
                     height=130)  # it is for decide the position of image in window by using place method

        # label frame inside left label frame and current course
        current_frame = LabelFrame(label_frameleft, bd=2, bg="white", relief=RIDGE, text="Current Course Informations",
                                   font=("times new roman", 12, "bold"))  # relief is used for border size
        ...
        dep_combo = ttk.Combobox(current_frame, textvariable=self.var_dept, font=("times new roman", 12, "bold"),
                                 width=25, state='readonly')
        # Here with help of tuple we dedign select box
        dep_combo["values"] = ("Select Department", "Civil Engineering", "Computer Science Engineering",
        ...
        # combo label
        course_combo = ttk.Combobox(current_frame, textvariable=self.var_course, font=("times new roman", 12, "bold"),
                                    width=25, state='readonly')
        # Here with help of tuple we dedign select box
        course_combo["values"] = (
        "Select Course", " Digital Electronics", " Signal and System", " BAsic Electrical Engineering",
        " Solid State Devices", "Electromagnetism", "other")
        ...
        year_combo = ttk.Combobox(current_frame, textvariable=self.var_year, font=("times new roman", 12, "bold"),
                                  width=25, state='readonly')
        # Here with help of tuple we dedign select box
        ...
        "Select the semester ", "first", "second", "third", " fourth", " fifth", " six", " seventh", "eight", "other")
        ...
        class_Student_Information_frame = LabelFrame(label_frameleft, bd=2, bg="white", relief=RIDGE,
                                                     text=" Student Class Information", font=(
            "times new roman", 12, "bold"))  # relief is used for border size)
        ...
        # entry box
        studentID_entryBox = ttk.Entry(class_Student_Information_frame, textvariable=self.var_stdID, width=27,
        ...
        # entry box
        studentName_entryBox = ttk.Entry(class_Student_Information_frame, textvariable=self.var_stdName, width=27,
                                         font=("times new roman", 12, "bold"))
        ...
        # entry box
        Roll_No_entryBox = ttk.Entry(class_Student_Information_frame, textvariable=self.var_stdrollno, width=27,
                                     font=("times new roman", 12, "bold"))
        ...
        group_combo = ttk.Combobox(class_Student_Information_frame, textvariable=self.var_stdgroup,
                                   font=("times new roman", 12, "bold"), width=25, state='readonly')
        # Here with help of tuple we dedign select box
        ...
        gneder_combo = ttk.Combobox(class_Student_Information_frame, textvariable=self.var_gender,
                                    font=("times new roman", 12, "bold"), width=25, state='readonly')
        # Here with help of tuple we dedign select box
        ...
        #  Mobile Number
        mobileNumber_label = Label(class_Student_Information_frame, text="MobileNO",
                                   font=("times new roman", 12, "bold"))
        mobileNumber_label.grid(row=2, column=2, padx=10, sticky=W)  # here grid property is used

        # entry box
        mobileNumber_entryBox = ttk.Entry(class_Student_Information_frame, textvariable=self.var_mobileNo, width=27,
                                          font=("times new roman", 12, "bold"))
        ...
        # entry box
        DOB_entryBox = ttk.Entry(class_Student_Information_frame, textvariable=self.var_dob, width=27,
                                 font=("times new roman", 12, "bold"))
        ...
        # entry box
        Email_entryBox = ttk.Entry(class_Student_Information_frame, textvariable=self.var_email, width=27,
                                   font=("times new roman", 12, "bold"))
        Email_entryBox.grid(row=3, column=3, padx=2, pady=10, sticky=W)

        #  Course_Cordinator
        Course_Cordinator_label = Label(class_Student_Information_frame, text="coordinator",
                                        font=("times new roman", 12, "bold"))
        Course_Cordinator_label.grid(row=4, column=0, padx=10, sticky=W)  # here grid property is used

        # entry box
        Course_Cordinator_entryBox = ttk.Entry(class_Student_Information_frame, textvariable=self.var_coordinator,
                                               width=27, font=("times new roman", 12, "bold"))
        ...
        # entry box
        Address_entryBox = ttk.Entry(class_Student_Information_frame, textvariable=self.var_Address, width=27,
                                     font=("times new roman", 12, "bold"))
        Address_entryBox.grid(row=4, column=3, padx=2, pady=10, sticky=W)

        # radio1 Box
        self.var_radio1 = StringVar()
        radio1_Button = ttk.Radiobutton(class_Student_Information_frame, variable=self.var_radio1,
                                        text="Take A Photo Sample", value="yes")
        # variable assign

        radio1_Button.grid(row=5, column=0)
        # radio2 Box

        radio2_Button = ttk.Radiobutton(class_Student_Information_frame, variable=self.var_radio1,
        ...
        # save Button
        Save_btn = Button(btn_frame, width=12, text="Save", command=self.add_data, font=("times new roman", 12, "bold"),
                          bg="darkblue", fg="white")
        Save_btn.grid(row=0, column=0)
        # Update Button
        Update_btn = Button(btn_frame, width=12, text=" Update", command=self.Update,
                            font=("times new roman", 12, "bold"), bg="darkblue", fg="white")
        Update_btn.grid(row=0, column=1)
        # delete Button
        delete_btn = Button(btn_frame, width=12, text="Delete", command=self.delete_data,
                            font=("times new roman", 12, "bold"), bg="darkblue", fg="white")
        delete_btn.grid(row=0, column=2)
        # Reset Button
        Reset_btn = Button(btn_frame, width=12, text="Reset", command=self.Reset_data,
                           font=("times new roman", 12, "bold"), bg="darkblue", fg="white")
        Reset_btn.grid(row=0, column=3)
        # Take photo Button
        photo_btn = Button(btn_frame, width=12, text="Take photo", command=self.generate_dataset,
                           font=("times new roman", 12, "bold"), bg="darkblue", fg="white")
        photo_btn.grid(row=0, column=4)
        # Upadate photo Button
        update_photo_btn = Button(btn_frame, width=12, text="update photo", font=("times new roman", 12, "bold"),
                                  bg="darkblue", fg="white")
        update_photo_btn.grid(row=0, column=5)  # CALLmain

        # right Side label frame
        label_frameright = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE, text="student Details",
                                      font=("tomes new roman", 12, "bold"))  # relief is used for border size
        label_frameright.place(x=740, y=5, width=715, height=620)

        # right frame image
        right_img = Image.open(
            r"C:\Users\kumar\Desktop\college_images\student.jpeg ")  # for calling the images fromfolder to window
        ...
        f2_lbl.place(x=5, y=0, width=708,
                     height=130)  # it is for decide the position of image in window by using place method

        # label frame inside right label frame
        search_frame = LabelFrame(label_frameright, bd=2, bg="white", relief=RIDGE, text="Search System ",
                                  font=("times new roman", 12, "bold"))  # relief is used for border size
        ...
        # save Button
        search_btn = Button(search_frame, width=10, text="  Search", font=("times new roman", 12, "bold"),
                            bg="darkblue", fg="white")
        search_btn.grid(row=0, column=3, padx=3)
        # Update Button
        ShowAll_btn = Button(search_frame, width=10, text="  ShowAll ", font=("times new roman", 12, "bold"),
                             bg="darkblue", fg="white")
        ...
        "Department", "Course", "Year", "Semester", "StudentID", "StudentName", "StudentRollNo", "StudentGroup",
        "Gender", "MobileNo", "DOB", "Email", "coordinator", "Address", "PhotoSample"), xscrollcommand=scroll_x.set,
        ...
        self.student_table.bind("<ButtonRelease>",
                                self.get_cursor)  ######line for focus the cursor requiered  for bnd the table button thre aremay type of button one is ButtonRelase
    ...
    def add_data(self):
        if self.var_dept.get() == "Select Department" or self.var_course.get() == "" or self.var_stdID.get() == "":
            ...
            try:
                ...
                connection = mysql.connector.connect(host="localhost", username="root", password="W7301@jqir#",
                                                     database="face_recogntion")  # required all four variable for connect mysql to python
    ...
    def get_cursor(self, event=""):  # by default put Event
        ...
        content = self.student_table.item(
            cursor_focus)  # for getteing the variable data from the student tabel andfocusit
        data = content["values"]
        ...
        if self.var_dept.get() == "Select Department" or self.var_course.get() == "" or self.var_stdID.get() == "":
            ...
            try:
                ...
                face_classifier = cv2.CascadeClassifier(
                    "haarcascade_frontalface_default.xml")  # froload haar cascade xml file here
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        File_For_storing_capcropped_img = "DATAIMG/user." + str(id) + "." + str(
                            img_id) + ".jpg"  #### for storing the capcuture image in folder name DATAIMG with all image name user
